...
//        images?.add(R.drawable.album_7)
    ...
    fun cacheImage(idea: Idea, index: Int) {
        if (idea.localImageUrl != null) return

        Glide.with(this)
            .downloadOnly()
            .load(Utills.getCompleteUrl(idea.imageUrl))
            .into(object : CustomTarget<File>() {
                ...
                override fun onResourceReady(
                    ...
                    idea.localImageUrl = resource.absolutePath
                    Utills.updateInspirationalIdeasLocalImagesUrlDatabase(this@InspirationalIdeasActivity, resource.absolutePath, index)
                }
